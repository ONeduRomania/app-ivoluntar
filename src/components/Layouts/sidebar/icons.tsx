...
export function TimeTrackingIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25C6.615 2.25 2.25 6.615 2.25 12S6.615 21.75 12 21.75 21.75 17.385 21.75 12 17.385 2.25 12 2.25zM.75 12C.75 5.787 5.787.75 12 .75S23.25 5.787 23.25 12 18.213 23.25 12 23.25.75 18.213.75 12z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 6.25a.75.75 0 01.75.75v4.69l3.28 3.28a.75.75 0 11-1.06 1.06l-3.5-3.5a.75.75 0 01-.22-.53V7a.75.75 0 01.75-.75z"
      />
    </svg>
  );
}

export function DocumentsIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.5 3.75a1.5 1.5 0 00-1.5 1.5v13.5a1.5 1.5 0 001.5 1.5h15a1.5 1.5 0 001.5-1.5V5.25a1.5 1.5 0 00-1.5-1.5h-15zM2.25 5.25A2.25 2.25 0 014.5 3h15A2.25 2.25 0 0121.75 5.25v13.5A2.25 2.25 0 0119.5 21h-15a2.25 2.25 0 01-2.25-2.25V5.25z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.5 8.25a.75.75 0 000 1.5h9a.75.75 0 000-1.5h-9zM7.5 11.25a.75.75 0 000 1.5h9a.75.75 0 000-1.5h-9zM7.5 14.25a.75.75 0 000 1.5h6a.75.75 0 000-1.5h-6z"
      />
    </svg>
  );
}

export function PhoneBookIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.25 4.5A2.25 2.25 0 006 6.75v10.5A2.25 2.25 0 008.25 19.5h7.5A2.25 2.25 0 0018 17.25V6.75A2.25 2.25 0 0015.75 4.5h-7.5zM7.5 6.75a.75.75 0 01.75-.75h7.5a.75.75 0 01.75.75v10.5a.75.75 0 01-.75.75h-7.5a.75.75 0 01-.75-.75V6.75z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.5 8.25a1.5 1.5 0 100 3 1.5 1.5 0 000-3zM8.25 9.75a2.25 2.25 0 114.5 0 2.25 2.25 0 01-4.5 0z"
      />
      <path d="M8.25 13.5a3 3 0 014.5 0v.75a.75.75 0 01-1.5 0v-.75a1.5 1.5 0 00-3 0v.75a.75.75 0 01-1.5 0v-.75z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.5 8.25a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H14.25a.75.75 0 01-.75-.75zm0 3a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H14.25a.75.75 0 01-.75-.75zm0 3a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5a.75.75 0 01-.75-.75z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6 5.25a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5A.75.75 0 016 5.25zm10.5 0a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5a.75.75 0 01-.75-.75zm-10.5 13.5a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5a.75.75 0 01-.75-.75zm10.5 0a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5a.75.75 0 01-.75-.75z"
      />
    </svg>
  );
}

export function OrganizationChartIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zM8.25 4.5a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.5 9.75a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zM2.25 12a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0zM19.5 9.75a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zM17.25 12a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0zM12 17.25a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zM9.75 19.5a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0z"
      />
      <path d="M12 6.75a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V7.5a.75.75 0 01.75-.75zM6.75 12a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H7.5a.75.75 0 01-.75-.75zM14.25 12a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H15a.75.75 0 01-.75-.75zM12 14.25a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V15a.75.75 0 01.75-.75z" />
    </svg>
  );
}

export function CommunitiesIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM9.75 6a2.25 2.25 0 114.5 0 2.25 2.25 0 01-4.5 0z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.25 13.5a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM3 16.5a2.25 2.25 0 114.5 0 2.25 2.25 0 01-4.5 0zM18.75 13.5a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM16.5 16.5a2.25 2.25 0 114.5 0 2.25 2.25 0 01-4.5 0z"
      />
...
export function ResourcesIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3 3.75A2.25 2.25 0 015.25 1.5h13.5A2.25 2.25 0 0121 3.75v16.5A2.25 2.25 0 0118.75 22.5H5.25A2.25 2.25 0 013 20.25V3.75zm2.25-.75a.75.75 0 00-.75.75v16.5c0 .414.336.75.75.75h13.5a.75.75 0 00.75-.75V3.75a.75.75 0 00-.75-.75H5.25z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.5 6.75a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zm0 4.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zm0 4.5a.75.75 0 01.75-.75h5.25a.75.75 0 010 1.5H8.25a.75.75 0 01-.75-.75z"
      />
    </svg>
  );
}
...
export function EvaluationsIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75 2.25 17.385 2.25 12zM12 3.75a8.25 8.25 0 100 16.5 8.25 8.25 0 000-16.5z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16.03 9.97a.75.75 0 010 1.06l-5 5a.75.75 0 01-1.06 0l-2.5-2.5a.75.75 0 111.06-1.06l1.97 1.97 4.47-4.47a.75.75 0 011.06 0z"
      />
    </svg>
  );
}
